import { buildDescribePrompt, coerceNumber, DEFAULT_CLASSIFY_PROMPT, normalizeStringArray, safeJsonParse, } from './utils.js';
const DEFAULT_MODEL = 'gemini-2.0-flash-exp';
const DEFAULT_ENDPOINT = 'https://generativelanguage.googleapis.com/v1beta';
const sleep = (ms) => new Promise((resolve) => setTimeout(resolve, ms));
const extractJsonFromResponse = (payload) => {
...
export class GeminiVisionClient {
    ...
    async generateWithImage(prompt, imageBase64, mimeType = 'image/jpeg') {
