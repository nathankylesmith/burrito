...
export type PlaceDetailsField = 'place_id' | 'name' | 'formatted_address' | 'geometry' | 'types' | 'price_level' | 'rating' | 'user_ratings_total' | 'photos' | 'reviews' | 'website' | 'international_phone_number' | 'current_opening_hours';
